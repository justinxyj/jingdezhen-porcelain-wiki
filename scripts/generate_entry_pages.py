...
.wiki-entry-v2-tags{{display:flex;flex-wrap:wrap;gap:.4rem;margin:1rem 0 1.4rem}}.wiki-entry-v2-tags span{{padding:.32rem .6rem;border-radius:999px;background:#f1f4f7;font-size:.72rem;color:#687a8d}}.wiki-entry-world-path{{margin:16px 0 20px;padding:12px 14px;border:1px solid rgba(20,85,184,.11);border-radius:14px;background:rgba(20,85,184,.035)}}.wiki-entry-world-path>span{{display:block;margin-bottom:8px;font-size:9px;font-weight:800;letter-spacing:.12em;color:#6d8096}}.wiki-entry-world-path>div{{display:flex;flex-wrap:wrap;gap:7px}}.wiki-entry-world-link{{display:inline-flex;align-items:center;padding:7px 10px;border-radius:999px;background:#fff;border:1px solid rgba(20,85,184,.13);color:#1455b8!important;text-decoration:none!important;font-size:10px;font-weight:750}}
...
.wiki-entry-body h2,.wiki-entry-v2-section h2{{margin:.2rem 0 .8rem;font-size:25px;color:#0b2039}}.wiki-entry-body{{font-size:16px;line-height:1.95;max-width:820px}}.wiki-entry-body p{{margin:0 0 1rem;color:#172b43}}.wiki-entry-body h3{{margin:1.8rem 0 .65rem;font-size:20px;color:#17304d}}.wiki-entry-body ul,.wiki-entry-body ol{{padding-left:1.4rem}}.wiki-entry-body a{{color:#1455b8;text-decoration:underline;text-underline-offset:2px}}.wiki-entry-body h2:before,.wiki-entry-v2-section h2:before{{content:"";display:inline-block;width:4px;height:22px;margin-right:10px;border-radius:3px;background:#1455b8;vertical-align:-2px;opacity:.75}}.wiki-entry-body p,.wiki-entry-body li,.wiki-entry-v2-section p{{line-height:1.95}}.wiki-entry-body blockquote{{margin:1.25rem 0;padding:1rem 1.25rem;border-left:4px solid #1455b8;background:#f4f6f8;border-radius:0 10px 10px 0}}
.wiki-entry-v2-section{{margin:2.5rem 0;padding-top:1.5rem;border-top:1px solid var(--md-default-fg-color--lightest)}}.wiki-entry-v2-section>a{{display:inline-flex;align-items:center;margin-top:.25rem;padding:.45rem .7rem;border:1px solid var(--md-default-fg-color--lightest);border-radius:9px;background:#fff;color:#1455b8;text-decoration:none;font-size:11px;font-weight:700}}.wiki-entry-v2-section>a:hover{{border-color:#1455b8;transform:translateY(-1px)}}.wiki-entry-section-kicker{{font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;color:#1455b8;font-weight:800;margin-bottom:.25rem}}.wiki-entry-v2-relations{{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.7rem;list-style:none;padding:0;margin:1rem 0 0}}.wiki-entry-v2-relations a,.wiki-entry-v2-relations li{{display:flex;flex-direction:column;gap:.3rem;padding:.9rem 1rem;border:1px solid var(--md-default-fg-color--lightest);border-radius:12px;text-decoration:none;color:inherit;background:linear-gradient(180deg,#fff,#fbfcfd)}}.wiki-entry-v2-relations a:hover,.wiki-entry-v2-relations li:hover{{border-color:rgba(20,85,184,.25);transform:translateY(-2px)}}.wiki-entry-v2-relations span{{order:1;font-size:.66rem;text-transform:uppercase;letter-spacing:.08em;color:#7b8ea3}}.wiki-entry-v2-relations a{{order:2}}.wiki-entry-v2-relations b{{font-size:.95rem}}.wiki-entry-v2-relations small{{font-size:.72rem;line-height:1.55;color:#74869a}}
.wiki-entry-source-links{{display:flex;flex-wrap:wrap;gap:8px;list-style:none;padding:0;margin:0}}.wiki-entry-source-links li{{list-style:none}}.wiki-entry-source-links a{{display:inline-flex;padding:8px 11px;border:1px solid var(--md-default-fg-color--lightest);border-radius:10px;text-decoration:none;color:#1455b8;font-size:11px;background:#fff}}.wiki-entry-explore-grid{{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}}.wiki-entry-explore-card,.wiki-entry-craft-list>a{{display:flex;flex-direction:column;gap:5px;padding:13px 14px;border:1px solid rgba(7,26,53,.08);border-radius:14px;background:#fff;text-decoration:none!important;color:#10233f;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}}.wiki-entry-explore-card:hover,.wiki-entry-craft-list>a:hover{{transform:translateY(-2px);border-color:rgba(20,85,184,.24);box-shadow:0 10px 22px rgba(20,85,184,.07)}}.wiki-entry-explore-card span,.wiki-entry-craft-list span{{font-size:8px;letter-spacing:.08em;color:#7b8ea3}}.wiki-entry-explore-card b,.wiki-entry-craft-list b{{font-size:13px;line-height:1.45}}.wiki-entry-explore-card small,.wiki-entry-craft-list small{{font-size:9px;color:#74869a}}.wiki-entry-craft-list{{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}}.wiki-entry-recommendations{{margin:2.5rem 0 0;padding:1.5rem 0;border-top:1px solid var(--md-default-fg-color--lightest)}}.wiki-recommendation-intro{{margin:.2rem 0 1rem;opacity:.62;font-size:.82rem}}.wiki-recommendation-grid{{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.8rem}}.wiki-recommendation-card{{display:flex;flex-direction:column;gap:.35rem;padding:1rem 1.05rem;border:1px solid var(--md-default-fg-color--lightest);border-radius:13px;background:#fff;text-decoration:none!important;color:inherit!important;transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease}}.wiki-recommendation-card:hover{{transform:translateY(-3px);border-color:#1455b8;box-shadow:0 10px 26px rgba(25,47,64,.1)}}.wiki-recommendation-category{{font-size:.68rem;letter-spacing:.08em;opacity:.55}}.wiki-recommendation-card b{{font-size:1rem}}.wiki-recommendation-card small{{font-size:.76rem;line-height:1.55;opacity:.68}}.wiki-entry-recommendation-warning{{margin:.75rem 0;padding:.7rem .9rem;border-radius:10px;background:#f4f6f8;font-size:.78rem;color:#74869a}}.wiki-entry-relation-warning{{margin:.75rem 0;padding:.7rem .9rem;border-radius:10px;background:#f4f6f8;font-size:.78rem;color:#74869a}}.wiki-entry-relation-warning button{{margin-left:.5rem;border:1px solid rgba(7,26,53,.12);border-radius:8px;background:#fff;padding:.35rem .6rem;cursor:pointer}}.wiki-entry-error{{padding:2rem;border:1px solid var(--md-default-fg-color--lightest);border-radius:14px;background:#fff}}.wiki-entry-error button{{border:0;border-radius:8px;background:#1455b8;color:#fff;padding:.5rem .8rem;cursor:pointer}}.wiki-entry-loading{{padding:3rem;text-align:center;color:#7b8ea3}}.wiki-entry-footer{{margin-top:30px;padding-top:15px;border-top:1px solid var(--md-default-fg-color--lightest);color:#8291a0;font-size:11px}}
@media(max-width:900px){{.wiki-entry-explore-grid,.wiki-entry-craft-list{{grid-template-columns:repeat(2,minmax(0,1fr))}}.wiki-entry-header{{align-items:flex-start;flex-direction:column}}.wiki-entry-cover{{width:min(100%,520px)}}.wiki-entry-v2-grid{{grid-template-columns:1fr}}.wiki-entry-v2-rail{{position:static;display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}}}}@media(max-width:600px){{.wiki-entry-explore-grid,.wiki-entry-craft-list,.wiki-recommendation-grid{{grid-template-columns:1fr}}main{{padding:16px 12px 48px}}.wiki-entry-card{{padding:22px 18px 30px}}.wiki-entry-v2-rail,.wiki-entry-v2-relations{{grid-template-columns:1fr}}.wiki-entry-header h1{{font-size:42px}}}}
</style>
</head>
<body>
<main>
