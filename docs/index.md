  ...
  <main>
    <section class="jdm-v2-hero">
      ...
      <div class="jdm-v2-hero-copy jdm-reveal">
        <div class="jdm-overline">JINGDEZHEN · DIGITAL MUSEUM</div>
    ...
    <section id="timeline" class="jdm-v2-timeline">
      <div class="jdm-v2-container">
        <div class="jdm-section-label jdm-reveal">A THOUSAND YEARS · 千年时间轴</div>
    ...
    <section class="jdm-v2-map">
      <div class="jdm-map-card jdm-reveal">
        ...
        <div class="jdm-map-content"><div class="jdm-overline">WORLD KILN ATLAS · 全球窑址</div><h2>从景德镇，<br>看见世界。</h2><p>窑址、陶瓷城市、原料产地与贸易网络，在同一张地图上重新连接。</p><a href="museum/kiln-map/">打开全球窑址地图 →</a></div>
      </div>
    </section>
  </main>

  <footer class="jdm-footer">
    <div class="jdm-footer-inner"><div><strong>景德镇陶瓷数字博物馆</strong><br><small>Jingdezhen Porcelain Wiki · Digital Museum</small></div><small>以来源为基础，以器物为入口，以景德镇为中心观察世界陶瓷史。</small></div>
  </footer>
</div>
