...
(function(){
  ...
  function render(root,data){
    ...
    const connected=connections.length?'<div class="jdm-world-connections"><span class="jdm-world-overview-eyebrow">关联知识世界</span>'+connections.map(w=>'<a class="jdm-world-connection" href="'+worldUrl(w.slug)+'">'+esc(w.short_title||w.title)+' <b>'+w.count+'</b></a>').join('')+'</div>':'';
